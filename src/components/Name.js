...
function Name({homeRef}) {
    return (
      ...
      strings={[
        ...
        <IconButton sx={{color:'white'}} onClick={(e)=>window.open('https://drive.google.com/file/d/1WqV1cb8u9YKVvGtfAFyzTvrejBRPsti2/view')}><img src='https://ty.ie/wp-content/uploads/2019/07/cv-icon.png'alt='resume'style={{height:'40px',width:'40px'}} /><span style={{marginLeft:'16px'}}>Resume</span></IconButton>
        </div>
