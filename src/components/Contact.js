    ...
    return (
        ...
        <Container style={{display:'flex',justifyContent:'space-evenly'}}>
          ...
          <Container className='phone'>
            <img src='https://media1.giphy.com/media/mbW2nvTE0TUc5IgRMm/giphy.gif?cid=6c09b95292377b798e2a21062d1c0c31021cc4209e405fd6&rid=giphy.gif&ct=s'style={{width:'80px',height:'80px'}}/>
            <p style={{color:'rgb(248, 245, 207)',fontWeight:'bold'}}>Phone</p>
            <p style={{color:'rgb(248, 245, 207)',fontWeight:'bold'}}>+918121656640</p>
          </Container>  
          <Container className='phone'>
            <img className='emailicon'src='https://i.ibb.co/2nPyKbn/ezgif-3-6d2330e2b8.gif'style={{width:'70px',height:'70px'}}/>
          ...
          <Container className='phone'>
            <img className='emailicon'src='https://i0.wp.com/fiverrpromotion.com/wp-content/uploads/2022/03/63-home-flat.gif?fit=375%2C375&ssl=1'style={{width:'70px',height:'70px'}}/>
